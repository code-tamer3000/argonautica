          ...
          <div>
            ...
            <FadeSection delay={180}>
              <p style={{
                ...
                Аргонавтика как система говорит о&nbsp;том, что{' '}
                <strong style={emph}>лучшее в&nbsp;тебе существует изначально</strong>. Убери
                лишнее&nbsp;— и&nbsp;оно расцветёт.
                <br /><br />
                Аргонавты&nbsp;— это племя тех, кто <strong style={emph}>различает</strong> живое
                от&nbsp;неживого. Аргонавты находятся на&nbsp;острие развития сознания и&nbsp;создают
                канву Эпохи Перемен. Это проводники и&nbsp;лидеры своих стай.
                <br /><br />
                Аргонавт не&nbsp;боится тьмы, а&nbsp;смело идёт в&nbsp;неё и&nbsp;приручает самыми
                эффективными способами. Для аргонавтов{' '}
                <strong style={emph}>тьма&nbsp;— не&nbsp;враг, а&nbsp;строительный материал.</strong>
                <br /><br />
                Каждый аргонавт в&nbsp;душе знает, что пришёл сюда делать своё Дело. Аргонавтика
                создана, чтобы отсечь всё наносное и&nbsp;
                <strong style={emph}>проявить Дело согласно твоему Призванию.</strong>
              </p>
            </FadeSection>
          </div>
